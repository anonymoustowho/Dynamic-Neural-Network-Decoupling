...
parser.add_argument('--Lambda_k', dest='Lambda_k', help='sparse Lambda', default=0, type=float)
parser.add_argument('--Lambda_s', dest='Lambda_s', help='sparse Lambda', default=0, type=float)
parser.add_argument('--Lambda_m', dest='Lambda_m', help='conditional Lambda', default=0, type=float)
